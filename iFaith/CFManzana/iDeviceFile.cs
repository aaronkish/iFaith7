namespace CFManzana
{
    ...
    public class iDeviceFile : Stream
    {
        ...
        private iDeviceFile(iDevice phone, long handle, OpenMode mode)
        {
            this.phone = phone;
            this.mode = mode;
            this.handle = handle;
        ...
        public static unsafe iDeviceFile Open(iDevice phone, string path, FileAccess openmode)
        {
            long num;
            ...
            return new iDeviceFile(phone, num, none);
        }
        ...
        public override unsafe void Write(byte[] buffer, int offset, int count)
        {
            ...
            MobileDevice.AFCFileRefWrite(this.phone.AFCHandle, this.handle, buffer2, (uint) count);
        }
